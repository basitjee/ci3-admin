    ...
    <header class="app-header navbar">
      ...
      <ul class="nav navbar-nav d-md-down-none">
        <li class="nav-item px-3">
          <a class="nav-link" href="#"> <?php echo $this->session->flashdata('loginSuccess'); ?> Dashboard </a>
        </li>
        <li class="nav-item px-3">
                      ...
                      <tbody>
                        <tr>
                          <td class="text-center">
                            <div class="avatar">
                              <img class="img-avatar" src="<?php echo base_url(); ?>img/avatars/1.jpg" alt="admin@bootstrapmaster.com">
