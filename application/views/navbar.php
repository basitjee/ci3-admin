          ...
          <ul class="nav">
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url().'dashboard' ?>">
                ...
                <?php
                echo $this->lang->line('dashboard_menu');
                ?> 
            ...
            <li class="nav-item">
              <a href="<?php echo base_url().'getall' ?>" class="nav-link" >
                <i class="nav-icon icon-drop"></i> User Listing</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url().'new_user' ?>">
                <i class="nav-icon icon-pencil"></i> Add New User</a>
            </li>
            <li class="nav-title">Components</li>
            <li class="nav-item nav-dropdown">
              <a class="nav-link nav-dropdown-toggle" href="<?php echo base_url().'ajax_insert' ?>">
                <i class="nav-icon icon-puzzle"></i> Ajax Insert</a>
              <ul class="nav-dropdown-items">
                <li class="nav-item">
                  <a class="nav-link" href="adasd.html">
                    <i class="nav-icon icon-puzzle"></i> Sample</a>
                </li>
                <li class="nav-item">
            ...
            <li class="nav-item nav-dropdown">
              <a class="nav-link nav-dropdown-toggle" href="logout">
                <i class="nav-icon icon-cursor"></i> Logout</a>
              <ul class="nav-dropdown-items">
                <li class="nav-item">
